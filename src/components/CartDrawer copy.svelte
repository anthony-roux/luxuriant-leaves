    ...
    <div class="fixed inset-0 overflow-hidden">
      <div class="absolute inset-0 overflow-hidden">
        <div
          ...
          aria-role="dialog" <!-- Fix for incorrect aria-role -->
        >
          <div
              ...
              <div class="border-t border-zinc-200 py-6 px-4 sm:px-6">
                {#if $cart && $cart.lines?.nodes.length > 0}
                  ...
                  <div class="mt-6">
                    <a
                      href="/checkout"
                      class="flex items-center justify-center rounded-md border border-transparent bg-emerald-800 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-emerald-900"
                    >
                      Checkout
                    </a>
                  </div>
